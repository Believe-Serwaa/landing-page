  ...
  return (
    <section id="about" className="bg-blue-50 min-h-screen scroll-mt-[6rem]">
      ...
      <div className="container mx-auto px-4 py-12 sm:py-20 max-w-7xl">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-sky-500 mb-4">
            About Us
          </h1>
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Revolutionizing hygiene with cutting-edge technology for a healthier future.
          </p>
        </motion.div>
        ...
        <section className="py-8 sm:py-12">
          <div className="container mx-auto px-4 max-w-6xl">
            {/* Section Heading - Reduced margin-bottom */}
            <motion.h2
            ...
            >
              <span className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-cyan-500">
                Innovator Spotlight
              </span>
            </motion.h2>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              ...
              <div className="flex-1 relative z-10 pl-12 md:pl-16">
                ...
                <div className="prose prose-lg text-gray-600 mb-8 max-w-2xl">
                  <p>
                    The SmartBucket is an innovative IoT-based Veronica bucket designed to promote hygiene and prevent
                    the spread of diseases like cholera by eliminating direct hand contact.
                  </p>
                  <p className="mt-4">
                    Equipped with an automatic soap dispenser, touchless hand dryer, and sensor-activated water flow, it
